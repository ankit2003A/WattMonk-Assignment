...
class DocumentProcessor:
    ...
    def generate_embeddings(self, text: str) -> List[float]:
        ...
        try:
            ...
            print(f"Error generating embeddings with models/gemini-embedding-001: {e}")
            ...
            try:
                ...
                print(f"Generated embedding with fallback model (gemini-embedding-2-preview), length: {len(result['embedding'])}")
                return result['embedding']
            except Exception as e2:
                print(f"Fallback embedding (gemini-embedding-2-preview) also failed: {e2}")
                return []
